    ...
    <body>
        ...
        <div class="container">       
            ...
            %>
                    ...
                    <button value="r" type="button" class="btn btn-info">Fund</button>

            <%  }else if(event.getFunding() == null && !(event.getFee().equals("Free")) ){

            %>
                    
                    <button value="r" type="button" class="btn btn-info">Pay </button>
            ...
            %>
                    ...
                    <p><b>Description:</b> <%= event.getFunding().getFundingnDesc()%> </p>
                    <hr>
                    <button value="r" type="button" class="btn btn-info">Pay/Fund</button>
